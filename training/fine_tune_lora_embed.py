...
from sentence_transformers.losses import MatryoshkaLoss, MultipleNegativesRankingLoss, OnlineContrastiveLoss, ContrastiveLoss, GISTEmbedLoss
...
args = SentenceTransformerTrainingArguments(
    output_dir="/mnt/data1tb/thangcn/datnv2/models/embed/multilingual-e5-large-lora", 
    num_train_epochs=5,                       
...
trainer.save_model()
trainer.push_to_hub('multilingual-e5-large-finetuned-lora')
